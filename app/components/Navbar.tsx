...
const Navbar = (props: Props) => {
  //writing some states
  //making showProfile state and showNav state of type boolean and its default value will be false.
    ...
    <div>
      <div className='flex items-center justify-between py-4 relative'>
        <div className='flex items-center md:space-x-10 lg:space-x-20'>
         <div className='font-semibold text-2xl'><a href="/">FEDSTORE</a></div>
        ...
        <div className='flex items-center space-x-4'>
            <SearchBar/>
            {/* defining onclick function to use usestate state. */}
